    ...
    <>
      ...
      <View style={[S.coCard, { backgroundColor: c.cardBg, borderColor: c.cardBorder }]}>
        ...
        <View style={S.bRow}>
          ...
          <Text style={[S.bVal, { color: c.text }]}>₱ {subtotal.toLocaleString()}</Text>
        </View>
        ...
        <View style={S.bRow}>
          ...
          <Text style={[S.bVal, { color: c.text }]}>₱ {tax.toLocaleString()}</Text>
        </View>
        ...
        <View style={S.bRow}>
          ...
          <Text style={[S.grandVal, { color: c.price }]}>₱ {grand.toLocaleString()}</Text>
        </View>
      </View>

      {/* ── Free-shipping congratulations banner ── */}
      {subtotal > 2000 && (
        <View style={[S.freeBanner, { backgroundColor: c.successBg }]}>
          <Text style={[S.freeBannerTxt, { color: c.successTxt }]}>
